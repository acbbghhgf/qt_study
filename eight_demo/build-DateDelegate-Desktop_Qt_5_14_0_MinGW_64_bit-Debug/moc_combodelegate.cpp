...
#include <memory>
#include "../DateDelegate/combodelegate.h"
...
QT_INIT_METAOBJECT const QMetaObject ComboDelegate::staticMetaObject = { {
    QMetaObject::SuperData::link<QItemDelegate::staticMetaObject>(),
    qt_meta_stringdata_ComboDelegate.data,
    qt_meta_data_ComboDelegate,
    qt_static_metacall,
    nullptr,
    nullptr
} };
