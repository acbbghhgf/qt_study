...
#include <memory>
#include "../DialogExample_demo/msgboxdlg.h"
...
QT_MOC_LITERAL(3, 27, 18), // "showInformationMsg"
QT_MOC_LITERAL(4, 46, 14), // "showWarningMsg"
QT_MOC_LITERAL(5, 61, 15), // "showCriticalMsg"
QT_MOC_LITERAL(6, 77, 12), // "showAboutMsg"
QT_MOC_LITERAL(7, 90, 14) // "showAboutQtMsg"
...
void MsgBoxDlg::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<MsgBoxDlg *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject MsgBoxDlg::staticMetaObject = { {
    ...
    qt_meta_stringdata_MsgBoxDlg.data,
    qt_meta_data_MsgBoxDlg,
    qt_static_metacall,
    nullptr,
    nullptr
} };
